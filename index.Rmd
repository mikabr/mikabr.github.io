...
I'm a postdoctoral scholar at the [Quantitative Sciences Unit](https://med.stanford.edu/qsu.html) at Stanford University. I work with [Maya Mathur](https://www.mayamathur.com) on tools for <strong>reducing bias in meta-analysis</strong> and on studies of interventions for <strong>reducing meat consumption</strong>.

Before that I got my PhD in [Brain and Cognitive Sciences](http://bcs.mit.edu) at MIT, where I studied <strong>language acquisition</strong>. I was advised by [Ted Gibson](http://tedlab.mit.edu/people.html) and also collaborated extensively with [Mike Frank](http://web.stanford.edu/~mcfrank/), [Virginia Marchman](https://profiles.stanford.edu/virginia-marchman), [Tim O'Donnell](http://people.linguistics.mcgill.ca/~timothy.odonnell/), and [Roger Levy](http://www.mit.edu/~rplevy/).
...
section_tags <- function(sec) {
  ...
  tagList(
    ...
    fluidRow(column(width = 6, sec_items[1:floor(n_items / 2)]),
             column(width = 6, sec_items[(floor(n_items / 2) + 1):n_items]))
